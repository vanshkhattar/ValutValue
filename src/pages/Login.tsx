...
const Login = () => {
  ...
  const onSubmitHandler = async (e: User, { resetForm }: any) => {
    try {
      ...
      if (rememberMe) toast.success("Remember me is active!");
  ...
  const triggerGoogleLogin = () => {
    ...
    else toast.error("Google button not ready yet");
  };
          ...
          >
            ...
            >
              ...
              <div className="mb-6">
                <label
                  htmlFor="email"
                  className="font-semibold block mb-2 text-gray-700"
                >
                  Email
                </label>
                <Field name="email">
                ...
                <ErrorMessage
                  component="small"
                  name="email"
                  className="text-red-500 block mt-1 text-sm"
                />
              </div>
                ...
                <Field name="password">
                  {({ field }: any) => (
                    <Password
                      ...
                      className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      // inputClassName="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  )}
                </Field>
              ...
              <Button
                ...
                label="Login"
                className="w-full bg-red-500 border-none hover:bg-red-600 text-white font-semibold py-3 text-base rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out"
              ...
              <div className="flex flex-col items-center space-y-3">
                ...
                <Button
                  ...
                  icon="pi pi-google"
                  className="w-full bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 font-semibold py-3 text-base rounded-lg shadow-sm"
